...
import { loadAIChatHistory, saveAIChatHistory, ChatMessage } from '@/utils/storageUtils';
...
export const DataProvider: React.FC<DataProviderProps> = ({ children }) => {
  ...
  const getWattBotResponse = async (message: string): Promise<string> => {
    try {
      ...
      const response = await generateGeminiResponse(message, chatHistory);
      
      // Save the new exchange to chat history
      const newHistory: AppChatHistoryItem[] = [
        ...chatHistory,
